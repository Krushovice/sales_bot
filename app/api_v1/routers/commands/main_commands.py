...
async def command_help_handler(message: Message):
    await message.answer_photo(
        ...
        caption="Чтобы стать нашим партнером и получать бонусы, необходимо\n приглашать "
        "новых пользователей по индивидуальной реферальной ссылке👥. За первого "
        "приглашенного начисляется скидка в размере 5%, за каждого "
        "последующего - 1%, но не более 50%. Ваша реферальную ссылку можно найти\n"
